...
const LOCAL_STORAGE_STAT_KEY = 'pairs_stats'
 ...
 * @param {String} statDiff Dificultad seleccionada
 * @param {Number} statTime Número de milisegundos que se ha tardado en finalizar la partida
 */
export function saveStats(statDiff, statTime) {
  const stat = {
    date: getCurrentDate(),
    diff: statDiff,
    time: statTime
